                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900"><?php echo e($order->user->name ?? 'N/A'); ?></div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <a href="<?php echo e(route('seller.orders.show', $order)); ?>" class="text-blue-600 hover:text-blue-900">
                                        ...
                                        <form action="<?php echo e(route('seller.orders.update-status', $order)); ?>" method="POST" class="inline-block">
                                            <?php echo csrf_field(); ?>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    ?>
                                    <div class="text-sm text-gray-900"><?php echo e($shippedDate->format('M d, Y')); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($shippedDate->format('h:i A')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                                        <?php echo e($order->status == 'completed' ? 'bg-green-100 text-green-800' : 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\BBvb-main\resources\views/seller/orders/index.blade.php ENDPATH**/ ?>