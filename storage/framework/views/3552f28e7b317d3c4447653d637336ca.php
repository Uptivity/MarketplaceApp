...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-8">
    <h1 class="text-2xl font-bold mb-6">Admin Dashboard</h1>    <?php if(session('success')): ?>
    ...
    <div class="mb-8 grid grid-cols-1 md:grid-cols-4 gap-6">
        <a href="<?php echo e(route('admin.users.index')); ?>" class="bg-white rounded-lg shadow p-6 hover:bg-blue-50 transition-colors flex items-center">
        ...
        <a href="<?php echo e(route('admin.settings.index')); ?>" class="bg-white rounded-lg shadow p-6 hover:bg-blue-50 transition-colors flex items-center">
          ...
          <a href="<?php echo e(route('products.index')); ?>" class="bg-white rounded-lg shadow p-6 hover:bg-blue-50 transition-colors flex items-center">
        ...
        <a href="<?php echo e(route('admin.categories.index')); ?>" class="bg-white rounded-lg shadow p-6 hover:bg-blue-50 transition-colors flex items-center">
    ...
    <div class="mb-8 grid grid-cols-1 md:grid-cols-4 gap-6">
        <a href="<?php echo e(route('admin.reviews.index')); ?>" class="bg-white rounded-lg shadow p-6 hover:bg-blue-50 transition-colors flex items-center">
    ...
    <div class="mb-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="<?php echo e(route('admin.analytics.index')); ?>" class="bg-white rounded-lg shadow p-6 hover:bg-blue-50 transition-colors flex items-center">
            <div class="bg-blue-100 p-3 rounded-full mr-4">
                <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="<?php echo e(route('admin.analytics.store')); ?>" class="bg-white rounded-lg shadow p-6 hover:bg-blue-50 transition-colors flex items-center">
            <div class="bg-green-100 p-3 rounded-full mr-4">
                <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                </svg>
        ...
        <a href="<?php echo e(route('admin.analytics.users')); ?>" class="bg-white rounded-lg shadow p-6 hover:bg-blue-50 transition-colors flex items-center">
            <div class="bg-purple-100 p-3 rounded-full mr-4">
                <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($stats['totalUsers'])); ?></p>
                <div class="mt-1 text-xs text-gray-500">
                    <span class="font-medium"><?php echo e($stats['buyerCount']); ?></span> Buyers |
                    <span class="font-medium"><?php echo e($stats['sellerCount']); ?></span> Sellers |
                    <span class="font-medium"><?php echo e($stats['adminCount']); ?></span> Admins
                </div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <h3 class="text-sm text-gray-500 uppercase tracking-wide">Total Products</h3>
                <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($stats['totalProducts'])); ?></p>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <h3 class="text-sm text-gray-500 uppercase tracking-wide">Total Orders</h3>
                <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($stats['totalOrders'])); ?></p>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <h3 class="text-sm text-gray-500 uppercase tracking-wide">Total Sales</h3>
                <p class="text-2xl font-bold text-gray-800">$<?php echo e(number_format($stats['totalSales'], 2)); ?></p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="divide-y divide-gray-200">
                ...
                <div class="px-6 py-4 bg-gray-50">
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="text-sm text-blue-600 hover:underline">View all users →</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="divide-y divide-gray-200">
                ...
                <div class="px-6 py-4">
                    <div class="flex justify-between">
                        <div>
                            <p class="font-medium text-gray-800">Order #<?php echo e($order->id); ?></p>
                            <p class="text-sm text-gray-500"><?php echo e($order->user->name ?? 'Unknown User'); ?></p>
                        </div>
                        <div>
                            <p class="font-medium text-gray-800">$<?php echo e(number_format($order->total_price, 2)); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\BBvb-main\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>