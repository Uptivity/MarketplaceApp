...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-4 text-sm">
            <a href="<?php echo e(route('public.products.index')); ?>" class="text-blue-500 hover:text-blue-700">Products</a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="flex justify-center">
                        <?php if(isset($product->image_path) && $product->image_path): ?>
                            <img src="<?php echo e(asset('storage/' . $product->image_path)); ?>" alt="<?php echo e($product->title); ?>" class="max-h-96 object-contain">
                        <?php else: ?>
                    ...
                    <div>
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <span class="text-gray-600 ml-2"><?php echo e($reviews->count()); ?> <?php echo e(Str::plural('review', $reviews->count())); ?></span>
                        </div>
                        
                        <!-- Price -->
                        <div class="mb-6">
                            <span class="text-3xl font-bold text-blue-700">$<?php echo e(number_format($product->price, 2)); ?></span>
                            <?php if(isset($product->original_price) && $product->original_price > $product->price): ?>
                                <span class="text-lg text-gray-500 line-through ml-2">$<?php echo e(number_format($product->original_price, 2)); ?></span>
                        ...
                        <?php if($product->quantity > 0): ?>
                            <form action="<?php echo e(route('cart.add', $product)); ?>" method="POST" class="mb-4">
                                <?php echo csrf_field(); ?>                                <div class="flex items-center mb-4">
                                    ...
                                    <select name="quantity" id="quantity" class="rounded-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                        <?php for($i = 1; $i <= min($product->quantity, 10); $i++): ?>
        ...
        <div class="mt-8 bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                    ...
                    <div class="space-y-6">
                        <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border-b pb-6">
                                ...
                                <p class="text-gray-600 mb-2"><?php echo e($review->comment); ?></p>
                                
                                <div class="text-sm text-gray-500 flex items-center">
                                    <span>By <?php echo e($review->user->name); ?></span>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="mt-8">
                        <a href="<?php echo e(route('reviews.create', ['product' => $product->id])); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150">
                            Write a Review
                        </a>
                    </div>
                <?php else: ?>
                    <div class="mt-8 text-gray-600">
                        Please <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:underline">log in</a> to write a review.
                    </div>
                <?php endif; ?>
            </div>
        </div>
                        ...
                        <?php $__currentLoopData = $similarProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $similarProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                                <div class="h-40 bg-gray-200">
                                    <?php if(isset($similarProduct->image_path) && $similarProduct->image_path): ?>
                                        <img src="<?php echo e(asset('storage/' . $similarProduct->image_path)); ?>" alt="<?php echo e($similarProduct->title); ?>" class="w-full h-full object-cover">
                                    <?php else: ?>
                                ...
                                <div class="p-4">
                                    <h3 class="text-gray-900 font-medium text-lg truncate"><?php echo e($similarProduct->title); ?></h3>
                                    <p class="text-blue-600 font-bold mt-2">$<?php echo e(number_format($similarProduct->price, 2)); ?></p>
                                    <a href="<?php echo e(route('public.products.show', $similarProduct)); ?>" class="mt-3 block text-center bg-gray-100 hover:bg-gray-200 py-2 px-4 rounded text-sm text-gray-800 font-medium">
                                        View Details
                                    </a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\BBvb-main\resources\views/public/products/show.blade.php ENDPATH**/ ?>