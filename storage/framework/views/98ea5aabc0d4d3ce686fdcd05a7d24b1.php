...
<div class="max-w-7xl mx-auto py-6">
    ...
    <?php if(count($cart) > 0): ?>
        ...
        <div class="flex justify-between items-center mt-6">
            <a href="<?php echo e(route('public.products.index')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200">
                ← Continue Shopping
            </a>
